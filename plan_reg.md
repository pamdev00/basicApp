...
* [x] Репозитории (CRUD, уникальность, индексы). - *написаны тесты для UserRepository и EmailVerificationTokenRepository*
* [x] Транзакционная согласованность user+token. - *написан интеграционный тест*
...
## 2.11. OpenAPI 3.1 (фрагмент) - *выполнено*

* [x] Описать схемы `RegisterRequest`, `VerifyRequest`, `ProblemDetails`.
* [x] Примеры payload/ответов.
* [x] Теги: `Auth`.

## 2.12. DoD / Критерии приемки

* [x] Все эндпоинты реализованы, соответствуют OpenAPI.
...
* [x] Повторная верификация — корректные коды (409/422).
* [x] Rate-limit/идемпотентность работает.
* [x] README с инструкцией запуска/переменными окружения.
